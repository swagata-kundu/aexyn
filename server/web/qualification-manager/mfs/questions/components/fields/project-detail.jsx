...
const ProjectDetail = ({ name, questionInfo, disabled }) => (
    ...
    <div className="form-field input-column clearfix">
      ...
      <div className="form-field-bottom-grop clearfix">
        <div className="column-1 four-col">
          <Field disabled={disabled} component="input" type="text" name={`${name}.name`} placeholder="Project Name" />
        </div>
        <div className="column-2 four-col">
          <Field disabled={disabled} component="input" type="text" name={`${name}.client`} placeholder="Client" />
        </div>
        <div className="column-3 dollar four-col">
          <div className="input-field">
            <Field disabled={disabled} component="input" type="number" name={`${name}.value`} placeholder="Contract Value" />
            <span className="dollar-icon">$</span>
          </div>
        </div>
        <div className="column-4 four-col">
          <div className="date-field">
            <Field disabled={disabled} component="input" type="date" name={`${name}.date`} placeholder="Completion Date" />
