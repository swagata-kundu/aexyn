            ...
            <div className="custom-mfs-section-1-inner clearfix">
                  ...
                  <div className="item">
                    ...
                    <div className="more-member">
                      <span className="reviewed-text">
                        Reviewers ( <span className="current-reviewer">1</span>{' '}
                        of <span className="total-reviewer">10</span> reviews
                        completed )
                      </span>
                      <ul>
                        <li>
              ...
              <div className="tab-content">
                <h3 className="blue-border">
                  Application Submitted <span className="count-value">(0)</span>
                  <span className="sort">
                    <img src="/static/images/sorting-icon.svg" />
                  </span>
                </h3>
